...
if (strlen($_SESSION['adid'] == 0)) {
    ...
    if (isset($_POST['submit-edit-mechanic-detail'])) {
        ...
        $query = mysqli_query($conn, "update  tblmechanics set FullName='$macname', MobileNumber='$mobno',Email= '$email', Address='$address' where ID=$mid");
        if ($query) {
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="p-20">
                                                    ...
                                                    <?php
                                                    $mid = substr(base64_decode($_GET['mecid']), 0, -5);
                                                    $ret = mysqli_query($conn, "select * from tblmechanics where ID='$mid'");
                                                    $cnt = 1;
